...
## [Context-aware Code Segmentation for C-to-Rust Translation using Large Language Models](paper_29.md)
...
## [Large Language Models Based Fuzzing Techniques: A Survey](paper_31.md)
...
## [Towards Translating Real-World Code with LLMs: A Study of Translating to Rust](paper_30.md)
...
## [VERT: Verified Equivalent Rust Transpilation with Large Language Models as Few-Shot Learners](paper_28.md)
