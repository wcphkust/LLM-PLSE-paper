...
[code generation](../../labels/code_generation.md)[compiler optimization](../../labels/compiler_optimization.md)[code model](../../labels/code_model.md)[code model training](../../labels/code_model_training.md)[IR code model](../../labels/IR_code_model.md)